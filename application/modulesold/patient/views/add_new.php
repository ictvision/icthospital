                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="patient/addNew" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">M.R<?php echo lang('m_r'); ?></label>
                                            <input type="text" class="form-control" name="m_r" id="m_r" value='<?php
                                            
                                            if (!empty($patient->m_r)) {
                                                echo $patient->m_r;
                                            }
                                            ?>' placeholder="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="remark" id="remark" value='<?php
                                            
                                            if (!empty($patient->remark)) {
                                                echo $patient->remark;
                                            }
                                            ?>' placeholder="">
                                        </div>
