    ...
    <section class="wrapper site-min-height">
        ...
        <section class="no-print col-md-8">
            <header class="panel-heading">
                MemberShip History
                <?php echo lang('member_history'); ?>
                <?php if(empty($expiry)){ ?>
                <div class="panel-body no-print pull-right">
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group">
                            <button id="" class="btn btn-xs green">
                                <i class="fa fa-plus-circle"></i> Add New Membership<?php echo lang('new_membership'); ?>
                            </button>
                        </div>
                    </a>   
                </div>
            ...
            <div class="panel panel-primary custom-panel">
                <div class="panel-body img-relative">
                    <img src="http://preview.thesoftking.com/thesoftking/discountcard/assets/frontend/upload/images/packages/8hM4J87Uc9w7rlC22IMRFyLdlix8rHkeFW7lhPil.jpeg">
                    <div class="tex-abs">
                        <h3><b><?php echo $expiry->membership_name; ?></b></h3>
                        <p><b style="color: #0e76a8">Card Holder Name: </b><?php echo $patient->name; ?></p>
                        <p><b>Valid Till</b> <?php echo $expiry->expiry; ?></p>
                        <p><b style="color: #0e76a8">Card No.: </b><?php echo $expiry->card_no; ?></p>
                    </div>
                </div>
            </div>
            <?php } ?>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        <thead>
                            <tr>
                                <th class="">Membership Name<?php echo lang('membershipname'); ?></th>
                                <th class=""><?php echo lang('price'); ?></th>
                                <th class=""><?php echo lang('discount'); ?></th>
                                <th class="">Card No<?php echo lang('card_no'); ?></th>
                                <th class="">Expiry Date<?php echo lang('expiry'); ?></th>
                                <th class="">Membership Date<?php echo lang('membershipdate'); ?></th>
                                <th class="no-print"><?php echo lang('status'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        //foreach ($membership_details as $detail) {
                            foreach ($membership_details as $detail) {
                                //if ($payment->date == $value) {
                                    ?>
                                    <tr class="">
                                        <td><?php echo $detail->membership_name; ?></td>
                                        <td> <?php echo $detail->membership_price; ?></td>
                                        <td><?php echo $detail->discount; ?></td>
                                        <td> <?php echo $detail->card_no; ?>
                                        </td>
                                        <td> <?php echo $detail->expiry; ?></td>
                                        <td> <?php echo $detail->date; ?></td>
                                        <td  class="no-print"> 
                                            <button type="button" href="javascript:void(0)" class="btn <?php if($detail->status=='Active'){ ?>editbutton<?php }else{ echo 'delete_button'; } ?>" title="<?php  echo lang('status'); ?>" ><i class="fa fa-edit"> </i><?php echo $detail->status; ?></button><?php  echo ' ';  ?>
                                        </td>
                                    </tr>
                            <?php
                            }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Add New Membership <?php echo lang('new_membership'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" action="patient/membership_add" id="membership-form" class="clearfix" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="patient" value="<?php echo $patient->patient_id; ?>">
                    <input type="hidden" name="patient_id" value="<?php echo $patient->id; ?>">
                    <div class="form-group"> 
                        <label for="exampleInputEmail1">Membership<?php echo lang('membership'); ?></label> 
                        <select class="form-control m-bot15 js-example-basic-single" id="" name="membership" value=''> 
