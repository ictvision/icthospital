                           ...
                           <!--   <section class="panel"> -->
                            <section class="">
                                ...
                                <div class="">
                                    ...
                                    <form role="form" id="editPaymentForm" class="clearfix" <?php if(isset($_GET['lab'])){ ?> action="lab/addLab" <?php }else{ ?> action="finance/addPayment" <?php } ?>  method="post" enctype="multipart/form-data">
                                             <?php if(isset($_GET['lab']) &&isset($_GET['lab_id']) ){ ?>
