    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
           ...
           <header class="panel-heading">
                Meetings Live Now <i class="fa fa-video"></i>
                <!--
                                -->
            </header>
                ...
                <div class="adv-table editable-table ">
                    ...
                    <?php foreach ($appointments as $appointment) { ?>
                        <tr>
                            ...
                            <td>  <?php echo $appointment->meeting_id; ?></td>
                            <td>  <?php echo $appointment->status; ?></td>
                            <td><a class="btn btn-info btn-xs btn_width invoicebutton" href="patient/meeting?id=<?php echo $appointment->meeting_id; ?>" delete="" onclick="return confirm('Are you sure you want to connect meeting?');"><i class="fa fa-phone"> </i></a></td>
                        </tr>
