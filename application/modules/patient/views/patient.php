    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            ...
            <header class="panel-heading">
                Out Door <?php echo lang('patient'); ?> <?php echo lang('database'); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="m_r" value="">
                    <!-- <div class="form-group col-md-12">
                        <label for="exampleInputEmail1">M.R#<?php //echo lang('mr_registration'); ?><small> (Medical Registration Number)</small></label>
                         <input type="text" class="form-control" readonly name="m_r" id="m_r" value='' placeholder="">
                    </div> -->
                    ...
                    <div class="form-group col-md-4">
                        <label for="exampleInputfathername">Father /Husband Name<?php echo lang('father_anme'); ?></label>
                        <input type="text" class="form-control" name="gardian_name" id="exampleInputfathername" value='' placeholder="">
                    </div>
                    ...
                    <!--  <div class="form-group col-md-6">
                        <label> B.P. (blood pressure)<?php echo lang('b_p'); ?></label>
                        <input class="form-control form-control-inline input-medium " type="text" name="pb" value="" placeholder="" >      
                    </div>
                     <div class="form-group col-md-6">
                        <label>Pulse<?php echo lang('pulse'); ?></label>
                        <input class="form-control form-control-inline input-medium " type="text" name="pulse" value="" placeholder="" >      
                    </div> 
                    <div class="form-group col-md-6">
                        <label>Weight<?php echo lang('weight'); ?></label>
                        <input class="form-control form-control-inline input-medium " type="text" name="weight" value="" placeholder="" >      
                    </div>
                    <div class="form-group col-md-6">
                        <label>Temperature<?php echo lang('temperature'); ?></label>
                        <input class="form-control form-control-inline input-medium " type="text" name="temperature" value="" placeholder="" >      
                    </div> -->
                    ...
                    <div class="form-group col-md-12">    
                        <label for="exampleInputEmail1">Remark<?php echo lang('remark'); ?></label>
                        <input class="form-control"  name="remark" value='<?php //echo $doctor->remark; ?>'> 
                        
                        
                    </div>
<!-- 
                    <div class="form-group col-md-12">
                        <label>Fee<?php echo lang('fee'); ?></label>
                        <input class="form-control form-control-inline input-medium " type="text" name="fee" value="" placeholder="" readonly='' >      
                    </div> -->
                    <div class="form-group col-md-12">
                        <label>Member Ship<?php echo lang('membership'); ?></label>
                        <select  class="form-control form-control-inline input-medium " name="membership"  > 
                        <option value=''></option>
                        <?php  
                        //echo "<pre>";print_r($setting_memberships);
                            if(!empty($setting_memberships)){
                                foreach($setting_memberships as $membership){
                        ?>
                        <option value='<?php echo $membership->id ?>'><?php echo $membership->membership_name ?>(Rs.<?php echo $membership->membership_price ?>)(<?php echo $membership->discount ?>%)</option>
                        <?php
                                }
                            }
                         ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                     <!-- <div class="form-group col-md-12">
                        <label for="exampleInputEmail1">M.R#<?php //echo lang('mr_registration'); ?><small> (Medical Registration Number)</small></label>
                         <input type="text" class="form-control" name="m_r" id="m_r" value='' placeholder="">
                    </div> -->
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?></label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" value='' placeholder="">
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            $('#editPatientForm').find('[name="m_r"]').val(response.patient.m_r).end()
            $('#editPatientForm').find('[name="remark"]').val(response.patient.remark).end()
