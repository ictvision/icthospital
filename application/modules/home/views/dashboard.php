    ...
    <body>
        <section id="container" class="">
            ...
            <header class="header white-bg">
               ...
               // echo "<pre>";print_r($settings_title);
                ...
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php if ($this->ion_auth->in_group(array('Patient'))) { ?>
                                <li class="">
                                <a href="patient/join_meetings" class="">
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist'))) { ?>
                            ...
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub"> 
                                    <li><a href="patient"><i class="fa fa-user"></i><?php echo lang('patient_list'); ?> (OutDoor) </a></li>
                                    <li><a href="patient/indoor"><i class="fa fa-user"></i><?php echo lang('patient_list'); ?> (InDoor) </a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Nurse', 'Receptionist'))) { ?>
                            ...
                            <li class="sub-menu">
                                <a href="javascript:;" >
                                    <i class="fa fa-stethoscope"></i> 
                                    <span><?php echo lang('appointment'); ?> (OPD)</span>
                                </a>
                                <ul class="sub"> 
                                    <li><a href="appointment"><i class="fa fa-list-alt"></i><?php echo lang('all'); ?></a></li>
                                    <?php /*<li><a href="appointment/addNewView"><i class="fa fa-plus-circle"></i><?php echo lang('add'); ?></a></li> */?>
                        ...
                        <?php /* if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Nurse', 'Receptionist'))) { ?>
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub"> 
                                    <li><a href="appointments"><i class="fa fa-list-alt"></i><?php echo lang('all'); ?></a></li>
                                    <li><a href="appointments/addNewViews"><i class="fa fa-plus-circle"></i><?php echo lang('add'); ?></a></li>
                                    <li><a href="appointments/todays"><i class="fa fa-list-alt"></i><?php echo lang('todays'); ?></a></li>
                                    <li><a href="appointments/upcomings"><i class="fa fa-list-alt"></i><?php echo lang('upcoming'); ?></a></li>
                                    <li><a href="appointments/calendars"><i class="fa fa-list-alt"></i><?php echo lang('calendar'); ?></a></li>
                                    <li><a href="appointments/requests"><i class="fa fa-list-alt"></i><?php echo lang('request'); ?></a></li>
                                </ul>
                            </li>
                        <?php } */ ?>
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        if ($this->ion_auth->in_group(array('Receptionist'))) {
                            ...
                            <li>
                                <a href="lab/lab1">
                                    <i class="fa fa-medkit"></i>
                                    <span>Lab patient List<?php echo lang('lab__reports'); ?></span>
                                </a>
                            </li>
                            <?php
                        }
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Doctor', 'Laboratorist'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a  href="lab"><i class="fa fa-file"></i>Lab patient List<?php echo lang('lab_patient_reports'); ?></a></li>
                                    <li><a  href="lab/addLabView"><i class="fa fa-plus-circle"></i><?php echo lang('add_lab_report'); ?></a></li>
                                    <li><a  href="lab/labCategory"><i class="fa fa-plus-circle"></i>Test Category<?php echo lang('Test Category'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="settings/membership"><i class="fa fa-gear"></i>Membership<?php echo lang('membership'); ?></a></li>
