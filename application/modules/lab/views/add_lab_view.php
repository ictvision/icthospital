                        ...
                        <div class="">
                           <!--   <section class="panel"> -->
                            ...
                            <div class="col-lg-3"></div>
                                    ...
                                    <form role="form" id="editPaymentForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12 payment pad_bot">
                                            ...
                                            <div class="pos_client">
                                                ...
                                                <div class="col-md-6 payment pad_bot">
                                                    ...
                                                    <input type="text" class="form-control pay_in" name="phone" value='<?php
                                                ...
                                                <div class="col-md-6 payment pad_bot">
                                                    <label for="exampleInputEmail1">Father \ Husband  <?php echo lang('father'); ?> <?php echo lang('name'); ?></label>
                                                    <input type="text" class="form-control pay_in" name="gardian" value='<?php
                                                    if (!empty($payment->father_name)) {
                                                        echo $payment->father_name;
                                                    }
                                                    ?>' placeholder="">
                                                </div>
                                                <div class="col-md-6 payment pad_bot">
                                                    <label for="exampleInputEmail1"> CNIC#<?php echo lang('cnic'); ?> </label>
                                                    <input type="text" class="form-control pay_in" name="cnic" value='<?php
                                                    if (!empty($payment->p_phone)) {
                                                        echo $payment->p_phone;
                                                    }
                                                    ?>' placeholder="">
                                                ...
                                                <div class="col-md-6 payment pad_bot">
                                                    ...
                                                    <input type="text" class="form-control pay_in" name="age" value='<?php
                                   ...
                                   /* if (!empty($lab_single->picker_name)) {
                                        echo $lab_single->picker_name;
                                    } else {
                                ...
                                <div class="col-md-6 lab pad_bot">
                                   ...
                                   /* if (!empty($lab_single->sample_no)) {
                                        echo  $lab_single->sample_no;
                                    } else {
                                        //echo date('d-m-Y H:i:s');
                                    }*/
                                    ?>' placeholder="" required>
                                ...
                                <div class="col-md-12 lab pad_bot">
                                    <label for="exampleInputEmail1">Specimen<?php //echo lang('date'); ?></label>
                                    <select  type="text" class="form-control  m-bot15 js-example-basic-single pay_in " name="specimen" required id="specimen">
                                        <option value="Taken in Lab">Taken in Lab</option>
                                        <option value="Home Collected">Home Collected</option>
                                        <option value="Out Source">Out Source</option>
                                    </select>
                                        

                                </div> 
                                <div class="col-md-12 lab pad_bot" id="pic">
                                    <label for="exampleInputEmail1"><?php echo lang('image'); ?></label>
                                    <input type="file" name="img_url" id="myinput" >
                                            ...
                                            <div class="col-md-6 lab pad_bot"> 
                                                ...
                                                <input type="text" class="form-control pay_in default-date-picker1" name="report_date" value='<?php
                                                if (!empty($lab->date)) {
                                                    echo date('d-m-Y', $lab->date);
                                                } else {
                                                    echo date('d-m-Y H:i:s');
                                            ...
                                            <div class="col-md-12 payment pad_bot">
                                                ...
                                                <select class="form-control m-bot15 js-example-basic-single pos_select" id="cat_select" name="category_id" value=''> 
                                                    <!-- <option value=""><?php //echo lang('select'); ?></option> -->
<!--                                                     <option value="add_new" style="color: #41cac0 !important;"><?php echo lang('add_new'); ?></option>
 -->                                                    <?php foreach ($categories_lab as $catlab) { ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 payment right-six">
                                                ...
                                                <div class=""> 
                                                    <input type="text" class="form-control pay_in" name="remarks" id="rem" value='<?php
...
<script>
    ...
    $('#specimen').change(function(){
        if($('#specimen').val() == 'Taken in Lab') {
           // alert($('#specimen').val());
           $('#pic').show(); 
           $('#myinput').clone().attr('type','file').insertAfter('#myinput').prev().remove();
           ...
           //$('#myinput').attr("required", "true");
            ...
            //$('#editPaymentForm').find('input:file').attr("type","text");
                $('#myinput').clone().attr('type','text').insertAfter('#myinput').prev().remove();
        ...
        $(document.body).on('change', '#pos_select', function () {
            ...
            if(v != 'add_new'){
                    ...
                    $.ajax({
                            ...
                            $('#rem').val('membership patient');
                           // ('#editPaymentForm').find('[name="dis"]').val(response).end()
