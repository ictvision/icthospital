                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th>Charges<?php echo lang('Charges'); ?></th>
                                <th>Sample Required<?php echo lang('Sample Required'); ?></th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($templates as $template) { 
                               ...
                               $charges =  $db->query("select * from payment_category where id = ".$template->procedure_id)->row();

                               $price = $charges->c_price;
                           }else{
                                $price = '';
                           }
...
//echo "<pre>";print_r($charges);
                                ...
                                <tr class="">
                                    ...
                                    <td> <?php echo $template->sample_required; ?></td>
                                    <td class="no-print">
