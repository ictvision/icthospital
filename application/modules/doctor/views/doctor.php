            ...
            <div class="modal-body row">
                <form role="form" action="doctor/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        <label for="exampleInputFEE">FEE<?php echo lang('fee'); ?></label>
                        <input type="text" class="form-control" name="fee" id="exampleInputFEE" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12">
            ...
            $.ajax({
               ...
               // alert(response.procedure);
                ...
                if(response.procedure==''){
                    $('#editDoctorForm').find('[name="fee"]').val(0);
                    $('#editDoctorForm').find('[name="fee_id"]').val('').end()

                }else{
                    $('#editDoctorForm').find('[name="fee"]').val(response.procedure.c_price).end()
                    $('#editDoctorForm').find('[name="fee_id"]').val(response.procedure.id).end()
                }
