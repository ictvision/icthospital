...
// Validating Description Field
    ...
    function invoice() {
        ...
        if( $lab_id ){
             ...
             $lab = $this->lab_model->getLabById( $lab_id);

             $center_name =  $this->lab_model->getLabCenterId( $lab->lab_center_id);

             $data['center'] = $center_name->name;
        }
       ...
       // exit;
        if(isset($appointment_id) && $appointment_id!=''){
             //echo $appointment_id  = $this->input->get('appointment_id');
             $data[] = $this->appointment_model->getAppointmentById($appointment_id);
             $data['appointment'] = $this->appointment_model->getAppointmentById($appointment_id);
