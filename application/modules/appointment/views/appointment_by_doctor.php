                            ...
                            if ($appointment->doctor == $doctor_id) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                       ...
                                       <a class="btn green" title="<?php echo lang('history'); ?>" style="color: #fff;" href="patient/medicalHistory?id=<?php echo $appointment->patient; ?>"><i class="fa fa-stethoscope"></i><?php echo lang('history')?></a>
                                    </td>
                                </tr>
                                <?php
                            }
