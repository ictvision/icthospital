                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $appointment->id; ?>"><i class="fa fa-edit"> <?php echo lang('edit'); ?></i></button>   
                                            ...
                                            //}
                                         ?>
                                         <a class="btn btn-info btn-xs btn_width invoicebutton" href="appointment/meeting?id=<?php echo $appointment->id; ?>" <?php echo lang('delete'); ?> onclick="return confirm('Are you sure you want to connect meeting?');"><i class="fa fa-phone"> </i></a>
                                     <?php } ?>
