                                ...
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_confirmeds as $appointment) { 
                                                 ...
                                                 $patient = $this->patient_model->getPatientById($appointment->patient);
                                                if (!empty($patient) && $patient->type=='outdoor') {
                                            ?>
                                            <tr class="">
                                                <td ><?php echo $appointment->id; ?></td>
                                                <td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="appointform" action="appointment/addNew" method="post" class="clearfix" enctype="multipart/form-data">
                    <div class="col-md-6 panel">
                        ...
                        <div class="pos_client clearfix col-md-6">
                            ...
                            <div class="payment pad_bot pull-right">
                                <label for="exampleInputEmail1">Father /Husband<?php echo lang('father_name'); ?> <?php echo lang('name'); ?></label> 
                                <input type="text" class="form-control pay_in" name="gardian_name" value='' placeholder="">
                            </div>
                            <div class="payment pad_bot pull-right">
                    ...
                    <div class="col-md-6 panel"  id="patient_d">
                    ...
                    <div class="col-md-6 panel">
                            ...
                            <input class="form-control" type="text" name="pb" value="" placeholder="" >      
                    </div>
                         <div class="col-md-6 panel">
                            <label>Pulse<?php echo lang('pulse'); ?></label>
                            <input class="form-control" type="text" name="pulse" value="" placeholder="" >      
                        </div> 
                        <div class="col-md-6 panel">
                            <label>Weight<?php echo lang('weight'); ?></label>
                            <input class="form-control  " type="text" name="weight" value="" placeholder="" >      
                        </div>
                        <div class="col-md-6 panel">
                            <label>Temperature<?php echo lang('temperature'); ?></label>
                            <input class="form-control  " type="text" name="temperature" value="" placeholder="" >      
                        </div>
                        <div class="col-md-6 panel">
                            <label>Doctor Fee<?php echo lang('doc_fee'); ?></label>
                            <input class="form-control  " type="text" name="doc_fee" value="" placeholder="" readonly="">      
                        </div>
                        <div class="col-md-6 panel">
                            <label><?php echo lang('discount'); ?></label>
                            <input class="form-control  " type="text" name="discount" value="" placeholder="" >      
                        </div>
                                                        ...
                                                        $(document).ready(function () {
                                                            $(".editbutton").click(function (e) {
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    $('#editAppointmentForm').find('[name="pb"]').val(response.appointment.b_p).end()
                                                                    $('#editAppointmentForm').find('[name="pulse"]').val(response.appointment.pulse).end()
                                                                    $('#editAppointmentForm').find('[name="weight"]').val(response.appointment.weight).end()
                                                                    $('#editAppointmentForm').find('[name="temperature"]').val(response.appointment.temprature).end()
...
<?php 
    ...
    $apointmet = $_GET['appointment_id'];
    $invoice_id = $_GET['id'];

?>
//window.open('appointment/printtoken?appointment_id=<?php echo $apointmet;  ?>', '_blank');
window.open('finance/invoice?id=<?php echo $invoice_id;  ?>&appointment_id=<?php echo $apointmet;  ?>', '_blank');
...
<?php } ?>
    $(document).ready(function () {
        ...
        $(document.body).on('change', '#pos_select', function () {
            ...
            if (v == 'add_new') {
                $('.pos_client').show();
                $( "#patient_d" ).removeClass( "col-md-6" ).addClass( "col-md-12" );
            } else {
                $('.pos_client').hide();
                $( "#patient_d" ).removeClass( "col-md-12" ).addClass( "col-md-6" );
            }
        });
    ...
    $(document).ready(function () {
        $("#adoctors").change(function () {
            ...
            $.ajax({
                ...
                //alert(response.procedure.c_price);
                //alert(response.procedure.id);
                var slots = response.aslots;
                $.each(slots, function (key, value) {
                ...
                if(response.procedure!=''){
                 $('#appointform').find('[name="doc_fee"]').val(response.procedure.c_price).end()
                 $('#appointform').find('[name="p_id"]').val(response.procedure.id).end()
                }
                // Populate the form fields with the data returned from server
                //  $('#default').find('[name="staff"]').val(response.appointment.staff).end()
            });
