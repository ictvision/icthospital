    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel col-md-6 row">
            ...
            <div class="panel-body">
                ...
                <form role="form" id="appointform" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="pos_client clearfix">
                        ...
                        <div class="col-md-8 payment pad_bot pull-right">
                            <div class="col-md-3 payment_label"> 
                                <label for="exampleInputEmail1"> <?php echo lang('patient'); ?> Father /Husband<?php echo lang('father'); ?></label>
                            </div>
                            <div class="col-md-9"> 
                                
                                <input type="text" class="form-control pay_in" name="gardian_name" value='<?php
                    ...
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                                <label> B.P. (blood pressure)<?php echo lang('b_p'); ?></label>                        </div>
                        <div class="col-md-9"> 
                            <input type="text" class="form-control" name="pb" id="exampleInputEmail1" value='' placeholder="">
                        </div>
                    </div>
                    <div class="col-md-12 panel">
                        <div class="col-md-3 payment_label"> 
                    ...
                    <div class="col-md-6 panel">
                        ...
                        <div class="col-md-6"> 
                            <input type="text" class="form-control" name="doc_fee" id="exampleInputEmail1" value='' placeholder="">
                        </div>
                    </div>
                     <div class="col-md-6 panel">
                        <div class="col-md-6 payment_label"> 
                        ...
                        <div class="col-md-6"> 
                            <input type="text" class="form-control" name="discount" id="exampleInputEmail1" value='' placeholder="">
                        </div>
                    </div>
